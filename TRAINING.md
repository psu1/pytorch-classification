...
#### experiment to do 
python cifar.py -a att_resnet --dataset cifar100 --depth 110 --epochs 164 --schedule 81 122 --gamma 0.1 --wd 1e-4 --checkpoint checkpoints/cifar100/att_resnet-110-new


## dropout experimrent
 python cifar.py -a dropout_resnet --dataset cifar100 --depth 110 --drop 0.1 --epochs 164 --schedule 81 122 --gamma 0.1 --wd 1e-4 --checkpoint checkpoint/cifar100/resnet_dropout1-110